...
public class MainWindow extends UiPart<Stage> {
     ...
     */
    void fillInnerParts() {
        personListPanel = new PersonListPanel(logic.getFilteredPersonList(), logic.getOriginalIndexesOfFilteredPersons());
        personListPanelPlaceholder.getChildren().add(personListPanel.getRoot());

        MeetingListPanel meetingListPanel = new MeetingListPanel(
            logic.getMeetingList()); // Adjust as necessary for meetings
